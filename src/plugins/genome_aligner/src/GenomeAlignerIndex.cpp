...
BinarySearchResult *GenomeAlignerIndex::bitMaskBinarySearchOpenCL(const BMType *bitValues,
                                                                  int size,
    ...
    BinaryFindOpenCL bf((NumberType*)indexPart.bitMask,
                        indexPart.getLoadedPartSize(),
                        (NumberType*)bitValues,
                        size,
                        windowSizes,
                        gpuNameMask);
